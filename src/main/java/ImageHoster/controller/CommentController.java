...
public class CommentController {
    ...
    // This method is called when the user submits the comment form to create a new comment
    // After getting all the required parameters, the comment needs to be persisted n the database
